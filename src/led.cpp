...
void setLedLevel()
{
 ...
 Serial.println(adcValue);
  if (adcValue > battLevel1)   {    digitalWrite(LED1, LOW);  }  else  {    digitalWrite(LED1, HIGH);  }
  if (adcValue > battLevel2)   {    digitalWrite(LED2, LOW);  }  else  {    digitalWrite(LED2, HIGH);  }
  if (adcValue > battLevel3)   {    digitalWrite(LED3, LOW);  }  else  {    digitalWrite(LED3, HIGH);  }
  if (adcValue > battLevel4)   {    digitalWrite(LED4, LOW);  }  else  {    digitalWrite(LED4, HIGH);  }
  if (adcValue > battLevel5)   {    digitalWrite(LED5, LOW);  }  else  {    digitalWrite(LED5, HIGH);  }
